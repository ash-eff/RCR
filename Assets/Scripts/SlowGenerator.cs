...
public class SlowGenerator : MonoBehaviour {
	...
	public Vector2 roomSizeWorldUnits = new Vector2(35,35);
	...
	[Range(.25f, 1)] public float chanceWalkerChangeDir = 0.6f, chanceWalkerSpawn = 0.05f;
			...
			for (int y = 0; y < roomHeight-1; y++){
				...
				if (grid[x,y] == gridSpace.wall){
					...
					if (allFloors){
						...
						DestroyImmediate(gridObjects[x,y]);
